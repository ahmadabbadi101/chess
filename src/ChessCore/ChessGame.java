...
public abstract class ChessGame {
    ...
    public ChessGame(ChessGame other) {
        this.board = new ChessBoard(other.getBoard());
        this.gameStatus = other.getGameStatus();
    ...
    public boolean isthereB1KnightWhite()
    {
        Square b1 = new Square(BoardFile.B, BoardRank.FIRST);
        return board.getPieceAtSquare(b1) instanceof Knight;
    }
    public boolean isthereB8KnightBlack()
    {
        Square b8 = new Square(BoardFile.B, BoardRank.EIGHTH);
        return board.getPieceAtSquare(b8) instanceof Knight;
    }
